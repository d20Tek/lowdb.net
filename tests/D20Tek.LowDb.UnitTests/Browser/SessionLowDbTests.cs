...
[TestClass]
public class SessionLowDbTests
{
    ...
    {
        // arrange
        var adapter = new SessionStorageAdapter<TestDocument>("foo-keyname", _storage);
    ...
    {
        // arrange
        var adapter = new SessionStorageAdapter<TestDocument>("", _storage);
        var db = new LowDb<TestDocument>(adapter);
